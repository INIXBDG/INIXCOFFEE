...
Route::middleware('auth')
    ->get('/notifications/unread-count', function () {
...
Route::get('inixcoffeeloglarapelixb95', [LogViewerController::class, 'index'])->middleware('logviewer.access');
...
Route::get('/chart/jumlah-update-materi-perbulan', [MateriController::class, 'chartJumlahUpdateMateriPerbulan'])
    ->name('chart.jumlah-update-materi-perbulan')
    ->middleware('auth');
...
Route::get('/chart/hari-mengajar-instruktur-per-tahun', [App\Http\Controllers\RKMController::class, 'chartHariMengajarInstrukturPerTahun'])->name('chart.hari-mengajar-instruktur-per-tahun');
...
Route::get('getPengajuanSubs/{month}/{year}', [App\Http\Controllers\PengajuanSubsController::class, 'getPengajuanLabSubs'])->name('getPengajuanSubs');
Route::put('pengajuansubs/updatesubs/{id}', [App\Http\Controllers\PengajuanSubsController::class, 'updateLabSubs'])->name('pengajuansubs.updatesubs');
...
Route::get('/api/get-master-subs', [App\Http\Controllers\PengajuanSubsController::class, 'getMasterLabs'])->name('api.master-subs');
Route::post('/api/master-subs', [App\Http\Controllers\PengajuanSubsController::class, 'storeMasterSubs'])->name('api.master-subs.store');
Route::put('/api/master-subs/{id}', [App\Http\Controllers\PengajuanSubsController::class, 'updateMasterLab']);
Route::post('/api/master-subs/{id}/renew', [App\Http\Controllers\PengajuanSubsController::class, 'renewLab']);
Route::get('/api/get-subs-by-rkm/{id}', [App\Http\Controllers\PengajuanSubsController::class, 'getLabsByRkm']);
...
// web.php
Route::post('/rkm/update-makanan', [App\Http\Controllers\RKMController::class, 'updateMakanan'])->name('rkm.updateMakanan');
...
Route::get('/management-kelas', [managementKelasController::class, 'index'])->name('managementKelas.index');
Route::get('/management-kelas/get', [managementKelasController::class, 'get'])->name('managementKelas.get');
...
Route::prefix('office')->group(function () {
    ...
    Route::post('administrasi-karyawan/eksport', [AdministrasiKaryawanController::class, 'eksport'])->name('administrasi.karyawan.eksport');
...
Route::prefix('office')
    ...
    ->group(function () {
        ...
        Route::get('/feedbackinstrukturpdf', [OfficeController::class, 'exportPdf'])->name('feedbackinstrukturpdf');
        ...
        Route::prefix('kendaraan')->group(function () {
            ...
            Route::post('/update/selesai/perbaikan', [KendaraanController::class, 'SelesaiPerbaikan'])->name('selesaiPerbaikanKendaraan');
...
// content
Route::patch('content-schedules/{contentSchedule}/mark-uploaded', [App\Http\Controllers\ContentScheduleController::class, 'markAsUploaded'])->name('content-schedules.mark-uploaded');
...
Route::middleware(['auth'])->group(function () {
    ...
    // Rute Serah Terima Proyek (Handover)
    Route::get('/projects/handovers', [ProjectHandoverController::class, 'index'])->name('handovers.index');
    Route::get('/projects/handovers/data', [ProjectHandoverController::class, 'getHandovers'])->name('handovers.data');
    Route::post('/projects/handovers/{id}/upload-bast', [ProjectHandoverController::class, 'uploadBAST'])->name('handovers.upload_bast');
});


Route::middleware(['auth'])->group(function () {
    Route::get('/pengajuanklaimmodul', [KlaimModulController::class, 'index'])->name('pengajuanklaimmodul.index');
    Route::get('/pengajuanklaimmodul/create', [KlaimModulController::class, 'create'])->name('pengajuanklaimmodul.create');
    Route::post('/pengajuanklaimmodul', [KlaimModulController::class, 'store'])->name('pengajuanklaimmodul.store');
    Route::get('/pengajuanklaimmodul/{id}', [KlaimModulController::class, 'show'])->name('pengajuanklaimmodul.show');
    Route::get('/pengajuanklaimmodul/{id}/edit', [KlaimModulController::class, 'edit'])->name('pengajuanklaimmodul.edit');
    Route::put('/pengajuanklaimmodul/{id}', [KlaimModulController::class, 'update'])->name('pengajuanklaimmodul.update');
