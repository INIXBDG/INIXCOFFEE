        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Daftar Lead (Lost)</h5>
                </div>
                <div class="card-body">
                    @if ($data->isEmpty())
                        <p class="text-muted">Tidak ada prospek LOST yang tercatat untuk sales ini.</p>
                    @else
                ...
                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="detailModalLabel">Detail Prospect LOST</h5>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-primary text-white fw-bold"
                                            style="font-size: 0.85rem; padding: 0.3rem 0.75rem; border-radius: 0.25rem 0.25rem 0 0;">
                                            Deskripsi Lost
                                        </div>
                                        <div class="card-body p-3" id="desc-lost-container" style="min-height: 20px;">
                                            <p id="desc-lost-text" class="mb-0 text-secondary" style="font-size: 0.9rem;">-</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
