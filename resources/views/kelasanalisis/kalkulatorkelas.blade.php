                        ...
                        <div class="card-body" id="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row mb-3">
                                        <label for="harga_modul_regular"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Harga Modul Regular') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="harga_modul_regular" type="text"
                                                    class="form-control"value="{{ $post->harga_modul_regular }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="harga_modul_regular_dollar"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Harga Modul Dalam Dollar') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">$</span>
                                                <input id="harga_modul_regular_dollar"
                                                    value="{{ $post->harga_modul_regular_dollar }}" type="text"
                                    ...
                                    <div class="row mb-3">
                                        <label for="kurs_dollar"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Kurs Dollar') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">$</span>
                                                <input id="kurs_dollar" type="text" value="{{ $post->kurs_dollar }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="biaya_modul_regular"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Biaya Modul Regular') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input readonly id="biaya_modul_regular" type="text"
                                                    value="{{ $post->biaya_modul_regular }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="biaya_modul_regular_dollar"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Biaya Modul Regular Dollar') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input readonly id="biaya_modul_regular_dollar" type="text"
                                                    value="{{ $post->biaya_modul_regular_dollar }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="exam"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Exam') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="exam" type="text"
                                                    class="form-control @error('exam') is-invalid @enderror"
                                                    value="{{ $post->exam }}" name="exam">
                                            </div>
                                            @error('exam')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="makan_siang" type="text" value="{{ $post->makan_siang }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="coffee_break"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Coffee Break') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="coffee_break" type="text"
                                                    value="{{ $post->coffee_break }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="konsumsi"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Konsumsi') }}</label>
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input readonly id="konsumsi" type="text"
                                                    class="form-control @error('konsumsi') is-invalid @enderror"
                                                    value="{{ $post->konsumsi }}" name="konsumsi"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="konsumsi_instruktur" id="konsumsi_instruktur" value="1"
                                                    {{ $post->konsumsi_instruktur == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        <label for="souvenir_satu"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Souvenir per Pax') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="souvenir_satu" type="text"
                                                    value="{{ $post->souvenir_satu }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="souvenir"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Souvenir') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input id="pc_pax" type="text"
                                                    ...
                                                    name="pc_pax" value="{{ $post->pc_pax }}" autocomplete="pc_pax"
                                                    autofocus>
                                            </div>
                                            @error('pc_pax')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="pc_instruktur"
                                                    id="pc_instruktur" value="1"
                                                    {{ $post->pc_instruktur == 1 ? 'checked' : '' }}>
                                                <label class="form-check-label" for="pc_instruktur">
                                                    + Instruktur
                                                </label>
                                            </div>
                                            <div class="form-check" id="pcpeserta">
                                                <input class="form-check-input" checked type="checkbox" name="pc_peserta"
                                                    id="pc_peserta" value="1">
                                    ...
                                    <div class="row mb-3">
                                        <label for="pc"
                                            class="col-md-4 col-form-label text-md-start">{{ __('PC') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input readonly id="pc" value="{{ $post->pc }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="alat"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Alat') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="alat" type="text" value="{{ $post->alat }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="pa_hotel"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Total Pa / Hotel') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input readonly id="pa_hotel" type="text"
                                                    value="{{ $post->pa_hotel }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="fee_instruktur"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Fee Instruktur') }}</label>
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="fee_instruktur" type="text"
                                                    class="form-control @error('fee_instruktur') is-invalid @enderror"
                                                    value="{{ $post->fee_instruktur }}" name="fee_instruktur"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                @if ($post->fee_instruktur == 0)
                                                    <input class="form-check-input" type="checkbox" name="ol"
                                                        id="ol" value="1" checked>
                                                @else
                                                    <input class="form-check-input" type="checkbox" name="ol"
                                                        id="ol" value="1">
                                                @endif
                                    ...
                                    <div class="row mb-3">
                                        <label for="total_fee_instruktur"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Total Fee Instruktur') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input id="total_fee_instruktur" type="text"
                                                    class="form-control @error('total_fee_instruktur') is-invalid @enderror"
                                                    value="{{ $post->total_fee_instruktur }}" name="total_fee_instruktur"
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row mb-3">
                                        <label for="nama_materi"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Nama Materi') }}</label>
                                        <div class="col-md-6">
                                            <input readonly id="nama_materi" type="text"
                                                ...
                                                name="nama_materi" value="{{ $post->rkm->materi->nama_materi }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="nama_perusahaan"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Nama Perusahaan') }}</label>
                                        <div class="col-md-6">
                                            <input readonly id="nama_perusahaan" type="text"
                                                placeholder="Masukan Nama Jabatan"
                                                class="form-control @error('nama_perusahaan') is-invalid @enderror"
                                                name="nama_perusahaan"
                                                value="{{ $post->rkm->perusahaan->nama_perusahaan }}"
                                    ...
                                    <div class="row mb-3" id="tanggal_awal-row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="date" class="form-control"
                                                value="{{ $post->rkm->tanggal_awal }}" name="tanggal_awal"
                                                id="tanggal_awal">
                                            @error('tanggal_awal')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row mb-3" id="tanggal_akhir-row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="date" class="form-control"
                                                value="{{ $post->rkm->tanggal_akhir }}" name="tanggal_akhir"
                                                id="tanggal_akhir">
                                            @error('tanggal_akhir')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <select name="kelas" id="kelas"
                                                ...
                                                <option value="Virtual"
                                                    {{ $rkm->metode_kelas == 'Virtual' ? 'selected' : '' }}>Virtual
                                                </option>
                                                <option value="Offline"
                                                    {{ $rkm->metode_kelas == 'Offline' ? 'selected' : '' }}>Offline
                                                </option>
                                                <option value="Inhouse Bandung"
                                                    {{ $rkm->metode_kelas == 'Inhouse Bandung' ? 'selected' : '' }}>Inhouse
                                                    Bandung</option>
                                                <option value="Inhouse Luar"
                                                    {{ $rkm->metode_kelas == 'Inhouse Luar' ? 'selected' : '' }}>Inhouse
                                                    Luar</option>
                                            </select>
                                    ...
                                    <div class="row mb-3" id="durasi-row">
                                        <label for="durasi"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Durasi Hari') }}</label>
                                        <div class="col-md-6">
                                            <input id="durasi" type="text" placeholder="Durasi"
                                                class="form-control @error('durasi') is-invalid @enderror" name="durasi"
                                                autocomplete="durasi" autofocus readonly>
                                            @error('durasi')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        <label for="pax"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Pax') }}</label>
                                        <div class="col-md-6">
                                            <input id="pax" type="text" placeholder="Pax"
                                                class="form-control @error('pax') is-invalid @enderror" name="pax"
                                                value="{{ $post->pax }}" autocomplete="pax" autofocus>
                                            @error('pax')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        <label for="harga_jual"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Harga Jual') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input type="text" step="0.01"
                                                    class="form-control @error('harga_jual') is-invalid @enderror"
                                                    name="harga_jual" value="{{ $post->rkm->harga_jual }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="total_harga_jual"
                                            class="col-md-4 col-form-label text-md-start">{{ __('Total Harga Jual') }}</label>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                <input type="text" value="{{ $post->total_harga_jual }}"
                                                    step="0.01"
    ...
    <script>
        ...
        function updateDurasi() {
            ...
            if (!isNaN(awal) && !isNaN(akhir)) {
                const timeDiff = akhir - awal;
                let daysDiff = Math.ceil(timeDiff / (1000 * 60 * 60 * 24)); // Konversi ke hari
                daysDiff += 1; // Hitung hari itu juga

                durasi.value = daysDiff >= 0 ? daysDiff + '' : '0';
            } else {
                durasi.value = '';
            }
        ...
        function updateTotalHargaJual() {
            ...
            const hargaJual = parseFloat(removeRupiahFormat(hargajualinput.value)) || 0;
        ...
        akhirinput.addEventListener('change', updateDurasi);
        ...
        function updatePC() {
            ...
            let pc;
            if (kelas === 'Virtual') {
                pc = pc_pax * durasi * inst;
            } else {
                pc = pc_pax * durasi * pax;
            }
        ...
        function calculateDuration() {
            ...
            if (!isNaN(startDate) && !isNaN(endDate)) {
                ...
                $('#durasi').val(daysDifference >= 0 ? daysDifference + 1 :
                    0); // Tambahkan 1 untuk menyertakan hari pertama
            } else {
