...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <form method="POST" action="{{ route('kelasanalisis.update', $post->id) }}" id="postedit">
            @csrf
            @method('PUT')
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="harga_modul_regular" type="text" class="form-control"value="{{$post->harga_modul_regular}}" @error('harga_modul_regular') is-invalid @enderror" name="harga_modul_regular" autocomplete="harga_modul_regular" autofocus>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="harga_modul_regular_dollar" value="{{$post->harga_modul_regular_dollar}}" type="text" class="form-control @error('harga_modul_regular_dollar') is-invalid @enderror" name="harga_modul_regular_dollar" autocomplete="harga_modul_regular_dollar" autofocus>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text" id="currency-symbol">$</span>
                                                <input id="kurs_dollar" type="text" value="{{$post->kurs_dollar}}" class="form-control @error('kurs_dollar') is-invalid @enderror" name="kurs_dollar" autocomplete="kurs_dollar" autofocus>
                                            </div>
                                            @error('kurs_dollar')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="biaya_modul_regular" type="text" value="{{$post->biaya_modul_regular}}" class="form-control @error('biaya_modul_regular') is-invalid @enderror" name="biaya_modul_regular" autocomplete="biaya_modul_regular" autofocus>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="biaya_modul_regular_dollar" type="text" value="{{$post->biaya_modul_regular_dollar}}" class="form-control @error('biaya_modul_regular_dollar') is-invalid @enderror" name="biaya_modul_regular_dollar" autocomplete="biaya_modul_regular_dollar" autofocus>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="exam" type="text" class="form-control @error('exam') is-invalid @enderror" value="{{$post->exam}}" name="exam">
                                        </div>
                                        @error('exam')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="makan_siang" type="text" value="{{$post->makan_siang}}" class="form-control @error('makan_siang') is-invalid @enderror" name="makan_siang" autocomplete="makan_siang" autofocus>
                                        </div>
                                        @error('makan_siang')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="coffee_break" type="text" value="{{$post->coffee_break}}" class="form-control @error('coffee_break') is-invalid @enderror" name="coffee_break" autocomplete="coffee_break" autofocus>
                                        </div>
                                        @error('coffee_break')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="konsumsi" type="text"  class="form-control @error('konsumsi') is-invalid @enderror" value="{{$post->konsumsi}}" name="konsumsi" autocomplete="konsumsi" autofocus>
                                        </div>
                                        @error('konsumsi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="souvenir_satu" type="text" value="{{$post->souvenir_satu}}" class="form-control @error('souvenir_satu') is-invalid @enderror" name="souvenir_satu" autocomplete="souvenir_satu" autofocus>
                                        </div>
                                        @error('souvenir_satu')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="souvenir" type="text"  value="{{$post->souvenir}}" class="form-control @error('souvenir') is-invalid @enderror" name="souvenir" autocomplete="souvenir" autofocus>
                                        </div>
                                        @error('souvenir')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="transportasi" type="text"  value="{{$post->transportasi}}" class="form-control @error('transportasi') is-invalid @enderror" name="transportasi" autocomplete="transportasi" autofocus>
                                        </div>
                                        @error('transportasi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="pc_pax" type="text" class="form-control @error('pc_pax') is-invalid @enderror" name="pc_pax" value="{{$post->pc_pax}}" autocomplete="pc_pax" autofocus>
                                        </div>
                                        @error('pc_pax')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="pc" value="{{$post->pc}}" type="text" class="form-control @error('pc') is-invalid @enderror" name="pc" autocomplete="pc" autofocus>
                                        </div>
                                        @error('pc')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="alat" type="text" value="{{$post->alat}}" class="form-control @error('alat') is-invalid @enderror" name="alat" autocomplete="alat" autofocus>
                                        </div>
                                        @error('alat')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    <label for="pa_hotel" class="col-md-4 col-form-label text-md-start">{{ __('Total Pa / Hotel') }}</label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input readonly id="pa_hotel" type="text" value="{{$post->pa_hotel}}"  class="form-control @error('pa_hotel') is-invalid @enderror" name="pa_hotel" autocomplete="pa_hotel" autofocus>
                                        </div>
                                        @error('pa_hotel')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="fee_instruktur" type="text" class="form-control @error('fee_instruktur') is-invalid @enderror" value="{{$post->fee_instruktur}}" name="fee_instruktur" autocomplete="fee_instruktur" autofocus>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text" id="currency-symbol">Rp.</span>
                                            <input id="total_fee_instruktur" type="text"  class="form-control @error('total_fee_instruktur') is-invalid @enderror" value="{{$post->total_fee_instruktur}}" name="total_fee_instruktur" autocomplete="total_fee_instruktur" autofocus>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input readonly id="nama_materi" type="text" placeholder="Masukan Nama Jabatan" class="form-control @error('nama_materi') is-invalid @enderror" name="nama_materi" value="{{$post->rkm->materi->nama_materi}}" autocomplete="nama_materi" autofocus>
                                                <input type="hidden" name="id_rkm" value="{{$post->rkm->id}}">
                                                @error('nama_materi')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input readonly id="nama_perusahaan" type="text" placeholder="Masukan Nama Jabatan" class="form-control @error('nama_perusahaan') is-invalid @enderror" name="nama_perusahaan" value="{{$post->rkm->perusahaan->nama_perusahaan}}" autocomplete="nama_perusahaan" autofocus>
                                        ...
                                        <div class="row mb-3" id="durasi-row">
                                            ...
                                            <div class="col-md-6">
                                                <input readonly id="kelas" type="text" placeholder="kelas" class="form-control @error('kelas') is-invalid @enderror" name="kelas" autocomplete="kelas" autofocus value="{{$post->rkm->metode_kelas}}">
                                                @error('kelas')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="pax" type="text" placeholder="Masukan Nama Jabatan" class="form-control @error('pax') is-invalid @enderror" name="pax" value="{{$post->pax}}" autocomplete="pax" autofocus>
                                                @error('pax')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                    <input type="text" step="0.01" class="form-control @error('harga_jual') is-invalid @enderror" name="harga_jual" value="{{$post->rkm->harga_jual}}" id="harga_jual" required>
                                                </div>
                                                @error('harga_jual')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="row mb-3">
                                            <label for="nett_penjualan" class="col-md-4 col-form-label text-md-start">{{ __('Nett Penjualan') }}</label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="currency-symbol">Rp.</span>
                                                    <input readonly type="text" step="0.01" value="{{$post->nett_penjualan}}" class="form-control @error('nett_penjualan') is-invalid @enderror" name="nett_penjualan" value="" id="nett_penjualan" required>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="komentar" type="text" placeholder="Keterangan" class="form-control @error('komentar') is-invalid @enderror" name="komentar" value="{{$post->komentar}}" autocomplete="komentar" autofocus>
                                                @error('komentar')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-0">
                                            <div class="col-md-6 offset-md-10">
                                                <button type="submit" disabled class="btn click-primary" id="btnsubmit">
                                                    {{ __('Simpan') }}
                                                </button>
                                            </div>
                                        </div>
...
<script>
    ...
    function updateHargaModulDollar() {
        var pax = parseInt($('#pax').val(), 10); // Mengonversi string ke integer
        var kurs = parseFloat(removeRupiahFormat($('#kurs_dollar').val()), 10); // Mengonversi string ke integer
        ...
        $('#biaya_modul_regular_dollar').val(formatRupiah(biaya_modul_regular_dollar.toString()));
    }
    ...
    function removeRupiahFormat(value) {
        // Assuming this function removes formatting and converts "Rp. 1,000" to "1000" or "-1,000" to "-1000"
