                        ...
                        <a class="dropdown-item" href="#">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img id="userAvatarDropdown" src="{{ asset('assets/img/avatars/1.png') }}" alt="User Avatar" class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-0" id="userFullName">Loading...</h6>
                                    <small class="text-body-secondary" id="userRole">Loading...</small>
                                </div>
                            </div>
                        </a>
                    </li>
