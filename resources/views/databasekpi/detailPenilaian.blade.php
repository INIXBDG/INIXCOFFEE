    ...
    <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        <span></span>Detail Penilaian <i
                            class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle" data-bs-toggle="tooltip"
                            data-bs-placement="top"
                            title="Anda hanya dapat mereview hasil penilaian, tapi tidak dengan melakukan aksi!"></i>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('ketegoriKPI.get') }}" class="btn text-white btn-danger mb-4"><i
                            ...
                            <div class="card p-3">
                                <div id="scrollable-table">
                                    <div class="d-flex justify-content-end me-5">
                                        <div>
                                            <div class="list-group text-center list-group-horizontal mb-3"
                                                id="jenis-penilaian-tab" role="tablist">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <canvas id="barChart"
                                            style="height: 139px; display: block; box-sizing: border-box; width: 278px;"
                                            width="834" height="417"></canvas>
                                    </div>
                                </div>
                            </div>
            ...
            `);
                ...
                globalKriteria.forEach(kriteria => {
                    ...
                    subKriteriaList.forEach((sub, idxSub) => {
                        ...
                        if (tipe === 'textarea') {
                            dataNilai =
                                `<td colspan="4">${pesan && pesan.trim() !== '' ? pesan : '-'}</td>`;
                        } else {
                        ...
                        <td>${rata === '-' ? '-' : pengubahFormat(skor)}</td>
                        `;
                        }
                        ...
                        const fullKriteriaContent = isKriteriaLong ?
                            `<span class="full-text" style="display:none;">${kriteriaText}</span><span class="short-text">${displayKriteria}</span><button class="btn btn-sm btn-link text-primary read-more-btn" type="button" onclick="toggleText(this)">...</button>` :
                            kriteriaText;
                        const fullSubKriteriaContent = isSubKriteriaLong ?
                            `<span class="full-text" style="display:none;">${subKriteriaText}</span><span class="short-text">${displaySubKriteria}</span><button class="btn btn-sm btn-link text-primary read-more-btn" type="button" onclick="toggleText(this)">...</button>` :
                            subKriteriaText;
