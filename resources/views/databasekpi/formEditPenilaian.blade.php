...
<div class="container mt-3" style="margin-bottom: 40px;">
    <a href="{{ route('penilaian.form.data') }}" class="btn text-white cl-blue my-2">
        ...
        <div class="col-md-12">
                        ...
                        <div id="kriteria-container">
                            ...
                            <div class="form-kriteria-block border rounded p-3 mb-4 bg-theme" data-kriteria-index="{{ $kIndex }}">
                                ...
                                <div class="form-wrapper-sub-kriteria">
                                    ...
                                    <div class="form-group-item p-3 border rounded mb-2 bg-theme" data-sub-kriteria-index="{{ $sIndex }}">
                                        <div class="row g-2 mb-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="kriteria[{{ $kIndex }}][sub_kriteria][{{ $sIndex }}][tipe_kategori]" class="form-control tipe-kategori" required>
                                        ...
                                        <div class="row g-2 mb-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="kriteria[{{ $kIndex }}][sub_kriteria][{{ $sIndex }}][level]" class="form-control" required>
            ...
            <div class="form-group-item p-3 border rounded mb-2 bg-theme" data-sub-kriteria-index="0">
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Tipe</label>
                        <select name="kriteria[${kriteriaMainIndex}][sub_kriteria][0][tipe_kategori]" class="form-control tipe-kategori" required>
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Level</label>
                        <select name="kriteria[${kriteriaMainIndex}][sub_kriteria][0][level]" class="form-control" required>
