                        ...
                        <div class="card my-2">
                            <div class="card-body">
                                ...
                                <h4 id="tunjangan-title" class="card-title text-center my-1">
                                    Tunjangan Anda pada Bulan
                                    {{ \Carbon\Carbon::createFromFormat('m', $month - 1)->locale('id_ID')->format('F Y') }}
                                </h4>
                                <div class="d-flex justify-content-end">
                                    <div class="d-flex justify-content-end">
                                        {{-- <a
                                            href="{{ route('generateTunjanganPDF', [
    ...
    @push('js')
        ...
        <script>
            ...
            function formatRupiah(angka, prefix) {
                ...
                var number_string = Math.abs(angka)
                    .toString(); // Menggunakan Math.abs untuk menghindari angka negatif pada proses formatting
                ...
                $('#table_tunjangan_saya').DataTable({
                    "ajax": {
                        ...
                        "dataSrc": function(json) {
                            // Simpan gaji global supaya bisa dipakai di footerCallback
                            window.gajiPokok = json.gaji || 0;
                            return json.data; // DataTables tetap pakai array 'data'
                        },
                        "beforeSend": function() {
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        // Ambil gaji dari response JSON (sudah disimpan ke window.gajiPokok)
                        var gajiPokok = parseFloat(window.gajiPokok || 0);
                        var totalBersih = gajiPokok + totalTunjangan + totalPotongan;
                        console.log(totalBersih, gajiPokok, totalTunjangan, totalPotongan);
