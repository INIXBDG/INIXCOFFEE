        ...
        <div class="panel panel-default">
            <div class="panel-body">
                    ...
                    <div class="col-md-6 col-sm-6 d-flex justify-content-end">
                        <div class="panel panel-default text-right">
                            <div class="panel-body d-print-none mt-4">
                                <a href="javascript:void(0);" class="btn btn-success me-1" id="printInvoice"><i class="fa fa-print"></i> Print Invoice</a>
                                @if (auth()->user()->jabatan == 'Office Manager' || auth()->user()->jabatan == 'Koordinator Office')
                                    <a class="btn btn-success me-1" href="{{ route('exam.createcc', $registexam->id) }}" data-toggle="tooltip" data-placement="top" title="Tambahkan Credit Card"><img src="{{ asset('icon/plus.svg') }}" class=""> Tambahkan CC</a>
                                @endif
                            </div>
                            @if (auth()->user()->jabatan == 'Office Manager' || auth()->user()->jabatan == 'Koordinator Office')
                                <div class="row mt-2">
                ...
                <div class="table-responsive">
                    <h5 class="text-center">Form Pengajuan Peserta Exam</h5>
                    <table class="table table-condensed nomargin">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: none">:</td>
                                <td>
                                    {{ \Carbon\Carbon::parse($registexam->tanggal_exam)->translatedFormat('d F Y') }}
                                </td>
                            </tr>
                            <tr>
                                <td style="border: none">
                                    <div><strong>Harga Exam per Peserta</strong></div>
                                </td>
                                <td style="border: none">:</td>
                                <td>
