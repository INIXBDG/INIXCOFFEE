                ...
                <h5 class="card-title text-center mb-4">{{ __('Tambah Credit Card') }}</h5>
                    <form method="POST" action="{{ route('creditcard.store') }}">
                        ...
                        <div class="row mb-3" style="display: none;">
                            ...
                            <div class="col-md-6">
                                <input id="angka_terakhir" type="text" value="0000" placeholder="Masukan 4 Angka Terakhir" class="form-control @error('angka_terakhir') is-invalid @enderror" name="angka_terakhir" value="{{ old('angka_terakhir') }}" autocomplete="angka_terakhir" autofocus>
