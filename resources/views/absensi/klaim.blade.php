        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body" id="card">
                    ...
                    <h5 class="card-title text-center mb-4">{{ __('Pengajuan Klaim') }}</h5>
                    <form method="POST" action="{{ route('pengajuanizin.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3" id="tanggal_absen-row">
                            ...
                            <div class="col-md-6">
                                <select name="tanggal_absen" class="form-control @error('tanggal_absen') is-invalid @enderror" required autocomplete="tanggal_absen" autofocus min="" id="tanggal_absen">
                        ...
                        <div class="row mb-3" id="bukti_gambar-row">
                            ...
                            <div class="col-md-6">
                                <input id="bukti_gambar" type="file" placeholder="Masukan Nama karyawan" class="form-control @error('bukti_gambar') is-invalid @enderror" name="bukti_gambar" autocomplete="bukti_gambar" autofocus>
                            </div>
                        </div>
