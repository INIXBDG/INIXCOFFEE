                ...
                <h5 class="card-title text-center mb-4">{{ __('Rate SPJ') }}</h5>
                    <form method="POST" action="{{ route('suratperjalanan.update', $suratperjalanan->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3" id="kontak-row">
                            ...
                            <div class="col-md-6">
                                <input  id="tujuan" type="text" placeholder="Kota yang dituju" class="form-control @error('tujuan') is-invalid @enderror" name="tujuan" value="{{ $suratperjalanan->tujuan }}" >
                                @error('tujuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3" id="tanggal_berangkat-row">
                            ...
                            <div class="col-md-6">
                                <input  type="datetime-local" class="form-control" name="tanggal_berangkat" id="tanggal_berangkat" value="{{ $suratperjalanan->tanggal_berangkat }}">
                        ...
                        <div class="row mb-3" id="tanggal_pulang-row">
                            ...
                            <div class="col-md-6">
                                <input  type="datetime-local" class="form-control" name="tanggal_pulang" id="tanggal_pulang" value="{{ $suratperjalanan->tanggal_pulang }}">
                        ...
                        <div class="row mb-3" id="durasi-row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="durasi" type="text" placeholder="Durasi" class="form-control @error('durasi') is-invalid @enderror" name="durasi" value="">
                                @error('durasi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  id="alasan" type="text" placeholder="Alasan" class="form-control @error('alasan') is-invalid @enderror" name="alasan" value="{{ $suratperjalanan->alasan }}">
                                @error('alasan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
