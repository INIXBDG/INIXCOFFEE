                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <form action="{{ route('pengajuanklaim.excelNoRecord') }}" method="post">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <img src="{{ asset('icon/file-excel.svg') }}" alt="" width="25px"> Rekap Excel
                                </button>
                            </form>
                            ...
                            <form action="{{ route('pengajuanklaim.PDFNoRecord') }}" method="post">
                                ...
                                <button type="submit" class="btn btn-danger">
                                    <img src="{{ asset('icon/document-pdf.svg') }}" alt="" width="25px"> Rekap PDF
                                </button>
                            </form>
                        </div>
