        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body" id="card">
                    ...
                    <p class="card-title text-center mb-5">{{ __('Keterlambatan Yang Diakibatkan Perubahan Skema Kerja') }}</p>
                    <form method="POST" action="{{ route('pengajuanklaim.addSchemeWork') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
