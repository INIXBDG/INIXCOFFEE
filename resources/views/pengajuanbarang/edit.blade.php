        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <h5 class="card-title text-center mb-4">{{ __('Edit Surat Perjalanan') }}</h5>
                    <form method="POST" action="{{ route('pengajuanbarang.update', $pengajuanbarang->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3" id="harga_rupiah_div">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" step="0.01" class="form-control @error('ratemakan') is-invalid @enderror" name="ratemakan" id="ratemakan" required>
                                </div>
                                @error('ratemakan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3" id="harga_rupiah_div">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rp.</span>
                                    <input type="text" step="0.01" class="form-control @error('ratespj') is-invalid @enderror" name="ratespj" id="ratespj" required>
                                </div>
                                @error('ratespj')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row mb-3" id="harga_rupiah_div">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rp.</span>
                                    <input type="text" step="0.01" class="form-control @error('ratetaksi') is-invalid @enderror" name="ratetaksi" id="ratetaksi" required>
                                </div>
                                @error('ratetaksi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
