...
<style>
    ...
    @keyframes animateLoaders {
        ...
        #progress-container {
            ...
            border-radius: 5px;
            margin-bottom: 10px;
            overflow: hidden; /* Ensure that elements stay inside the container */
        }
        #progress-bar {
            width: 0%; /* This will be dynamically updated with progress */
            height: 100%;
        ...
        #car {
            ...
            background-size: cover;
            position: absolute;
            top: 0; /* Adjust to 0 to make the car appear inside the progress bar */
            left: 0%; /* Start at 0 */
            z-index: 2; /* Ensure the car is above the progress bar */
        ...
        .horizontal-ruler-labels .label {
            font-size: 14px;
            text-align: center;
            transform: translateX(-50%); /* To center the labels on their calculated position */
            white-space: nowrap;
        }
        .tab-pane {
            position: relative;
        ...
        @media (max-width: 576px) {
             ...
             #navbarkanan {
                order: 2; /* Move navbarkanan after navbarpalingkanan */
                /* padding: 10px; */
            }
            #btngroupnavbar {
                padding: 10px;
            ...
            #navbarpalingkanan {
                order: 0; /* Move navbarpalingkanan before navbarkanan */
            }
            body{
                overflow-y: auto;
            }
        ...
        @media only screen and (max-width: 768px) {
            ...
            #chartjs {
                height: 300px; /* Kurangi tinggi pada perangkat mobile */
            ...
            #salesKeySelect {
                width: 100% !important; /* Dropdown seleksi menyesuaikan lebar layar */
            }
            #progress-bar-container {
                height: 30px; /* Reduce the height for mobile */
            }

            #car {
                top: -5px; /* Adjust the car position for mobile */
            }
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('notifications.markAllAsRead') }}" method="POST" class="d-inline">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm">Tandai Semua sebagai Dibaca</button>
                            </form>
                            @endif
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="overflow-y: scroll; height:400px">
                            {{-- {{$notifikasi}} --}}
                            @if ($notifikasi->sortByDesc('created_at')->filter(function($notif) {
                                return \Carbon\Carbon::parse($notif->tanggal_akhir)->lt(\Carbon\Carbon::parse($notif->tanggal_akhir)->addWeek());
                            })->isEmpty())
                                                        ...
                                                        @if ($notif->tipe_notifikasi == 'Libur')
                                                            <div class="card-title" style="text-transform: capitalize">Pengumuman <strong>{{ $notif->tipe_notifikasi }}</strong> Dari {{ $notif->id_user }} <b>{{ $notif->users->jabatan }}</b>
                                                                <p>{{ $notif->isi_notifikasi }}<br>
                                                                    ...
                                                                    @else
                                                                        Pada Tanggal {{ \Carbon\Carbon::parse($notif->tanggal_awal)->translatedFormat('d F Y') }} Sampai Tanggal {{ \Carbon\Carbon::parse($notif->tanggal_akhir)->translatedFormat('d F Y') }}
                                                                    @endif
                                                                </p>
            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
                <div class="container-fluid">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 d-flex justify-content-center" id="navbarkanan">
                        <div class="btn-group" role="group" aria-label="Basic example" id="btngroupnavbar">
                            <button type="button" class="btn btn-primary" id="pills-home-tab">Home</button>
                            <button type="button" class="btn btn-primary" id="pills-dashboard-tab">Dashboard</button>
                            @can('Akses Development')
                                <button type="button" class="btn btn-primary" id="pills-admin-tab">SuperAdmin</button>
                            @endcan
                        </div>                         
                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                        <div class="card" id="card-hover">
                                                            <div class="card-body d-flex">
                                                                <div class="col-md-2">
                                                                    <img src="{{ asset('icon/dollar-sign.svg') }}" class="img-responsive" width="30px">
                                                                </div>
                                                                <div class="col-md-10" style="margin-left: 10px">
                                                                    <a href="/tunjangan" class="link stretched-link text-decoration-none">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                        <div class="card" id="card-hover">
                                                            <div class="card-body d-flex">
                                                                <div class="col-md-2">
                                                                    <img src="{{ asset('icon/aperture.svg') }}" class="img-responsive" width="30px">
                                                                </div>
                                                                <div class="col-md-10" style="margin-left: 10px">
                                                                    <a href="/lembur" class="link stretched-link text-decoration-none">
                                                            ...
                                                            <div class="col-sm-6 mt-2">
                                                                <div class="card" id="card-hover">
                                                                    <div class="card-body d-flex">
                                                                        ...
                                                                        <div class="col-md-10" style="margin-left: 10px">
                                                                            <a href="/registexam" class="link stretched-link text-decoration-none"><h5 class="card-title">Registrasi Exam</h5></a>
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card" id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/exam" class="link stretched-link text-decoration-none"><h5 class="card-title">Pengajuan Exam</h5></a>
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card" id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/listexams" class="link stretched-link text-decoration-none"><h5 class="card-title">List Exam</h5></a>
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card" id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/kelasanalisis" class="link stretched-link text-decoration-none"><h5 class="card-title">Kelas Analisis</h5></a>
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card"  id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/tunjangangenerate" class="link stretched-link text-decoration-none">
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card"  id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/overtime" class="link stretched-link text-decoration-none">
                                                                ...
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card"  id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/souvenir" class="link stretched-link text-decoration-none"><h5 class="card-title">Souvenir</h5></a>
                                                            ...
                                                            @can('View Outstanding')
                                                                <div class="col-sm-6 mt-2">
                                                                    <div class="card"  id="card-hover">
                                                                        <div class="card-body d-flex">
                                                                            <div class="col-md-2">
                                                                                <img src="{{ asset('icon/bookmark.svg') }}" class="img-responsive" width="30px">
                                                                            </div>
                                                                            <div class="col-md-10" style="margin-left: 10px">
                                                                                <a href="/outstanding" class="link stretched-link text-decoration-none">
                                            ...
                                            <div class="col-md-12 mt-1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            @if (auth()->user()->jabatan == 'Direktur' || auth()->user()->jabatan == 'Direktur Utama' || auth()->user()->jabatan == 'GM')
                                                            <div class="col-sm-6 mt-2">
                                                                <div class="card"  id="card-hover">
                                                                    <div class="card-body d-flex">
                                                                        <div class="col-md-2">
                                                                            <img src="{{ asset('icon/target.svg') }}" class="img-responsive" width="30px">
                                                                        </div>
                                                                        <div class="col-md-10" style="margin-left: 10px">
                                                                            <a href="/target" class="link stretched-link text-decoration-none">
                                                            ...
                                                            <div class="col-sm-6 mt-2">
                                                                <div class="card" id="card-hover">
                                                                    <div class="card-body d-flex">
                                                                        ...
                                                                        <div class="col-md-10" style="margin-left: 10px">
                                                                            <a href="/tunjanganEducation" class="link stretched-link text-decoration-none">
                                                            ...
                                                            <div class="col-sm-6 mt-2">
                                                                <div class="card"  id="card-hover">
                                                                    <div class="card-body d-flex">
                                                                        ...
                                                                        <div class="col-md-10" style="margin-left: 10px">
                                                                            <a href="/rekapmengajarinstruktur" class="link stretched-link text-decoration-none">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                        <div class="card"  id="card-hover">
                                                            <div class="card-body d-flex">
                                                                ...
                                                                <div class="col-md-10" style="margin-left: 10px">
                                                                    <a href="/inixcoffeeloglarapelixb95" class="link stretched-link text-decoration-none">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                        <div class="card"  id="card-hover">
                                                            <div class="card-body d-flex">
                                                                ...
                                                                <div class="col-md-10" style="margin-left: 10px">
                                                                    <a href="/permissions" class="link stretched-link text-decoration-none">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                        <div class="card"  id="card-hover">
                                                            <div class="card-body d-flex">
                                                                ...
                                                                <div class="col-md-10" style="margin-left: 10px">
                                                                    <a href="/userRolePermissions" class="link stretched-link text-decoration-none">
        ...
        $('#btnAbsen').on('click', function(e) {
            ...
            $('#takeSnapshot').off('click').on('click', function() {
                Webcam.snap(function(data_uri) {
                    ...
                    var jamSekarang = now.toTimeString().split(' ')[0]; // Mendapatkan waktu dalam format HH:mm:ss
