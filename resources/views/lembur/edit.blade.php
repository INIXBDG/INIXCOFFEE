            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <h5 class="card-title text-center mb-4">{{ __('Perintah Lembur') }}</h5>
                        <form method="POST" action="{{ route('lembur.update', $data->id) }}" id="formEditLemburManager">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
    ...
    $(document).ready(function() {
        ...
        $('#formEditLemburManager').on('submit', function(e) {
            const form = $(this);
            ...
            // Jika ada error, cegah submit dan tampilkan popup
            if (!isValid) {
                e.preventDefault();
        ...
        $('#formEditLemburManager').on('input change', 'input, select, textarea', function() {
            const $field = $(this);
