                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-light text-dark border" data-bs-toggle="tooltip"
                                            title="Baseline terakhir setelah update">
                                            {{ number_format($item->stock_awal) }}
                                        </span>
                                    </td>
                                    <td class="editable" contenteditable="true" data-id="{{ $item->id }}"
                                        data-field="stock_sekarang" data-placeholder="Isi stock aktual">
                                        {{ $item->stock_sekarang }}
                                    </td>
                                    <td class="editable" contenteditable="true" data-id="{{ $item->id }}"
                                        data-field="kategori">
                                    ...
                                    <td class="editable" style="min-width: 500px; max-width: 500px; white-space: normal;"
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <button type="button" class="dropdown-item btnEdit"
                                                        ...
                                                        data-stock_sekarang="{{ $item->stock_sekarang }}"
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item btnSyncBaseline"
                                                        data-id="{{ $item->id }}"
                                                        data-stock="{{ $item->stock_sekarang }}">
        ...
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button id="refreshButton" class="btn btn-ligth">
                        Refresh
                        </a>
                </div>
            </div>
                ...
                <form id="formEditBarang">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" name="stock_sekarang" id="edit_stock_sekarang" class="form-control"
                                required>
                        </div>
                        <div class="form-group mt-3">
                            <label>Kategori</label>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-light text-dark border" data-bs-toggle="tooltip" title="Baseline terakhir setelah update">${numberFormat(item.stock_awal)}</span></td>
                            <td class="editable" contenteditable="true" data-id="${item.id}" data-field="stock_sekarang" data-placeholder="Isi stock aktual">${item.stock_sekarang}</td>
                            ...
                            <td class="editable" style="min-width: 500px; max-width: 500px; white-space: normal;" contenteditable="true" data-id="${item.id}" data-field="notes" data-placeholder="Kosong">${item.notes || ''}</td>
                            ...
                            <td>
                                <div class="input-group mb-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><button type="button" class="dropdown-item btnEdit" data-bs-toggle="modal" data-bs-target="#modalEditBarang" data-id="${item.id}" data-kode="${item.kode_barang}" data-nama="${item.nama_barang}" data-stock_awal="${item.stock_awal}" data-stock_sekarang="${item.stock_sekarang}" data-kategori="${item.kategori}" data-satuan="${item.satuan}" data-notes="${item.notes}" data-pic="${item.pic}"><i class="fas fa-edit"></i> Edit</button></li>
                                        <li><button type="button" class="dropdown-item btnSyncBaseline" data-id="${item.id}" data-stock="${item.stock_sekarang}"><i class="fas fa-sync"></i> Jadikan Baseline</button></li>
            ...
            function bindEditableEvents() {
                ...
                $('.editable').off('blur').on('blur', function() {
                    ...
                    if (field === 'stock_sekarang' && parseInt(newValue) < 0) {
                        showToast('Stock tidak boleh negatif', 'error');
                        cell.text(oldValue);
                        return;
                    }
            ...
            $(document).on('click', '.btnEdit', function() {
                ...
                $('#edit_stock_sekarang').val($(this).data('stock_sekarang'));
            ...
            function loadLog() {
                ...
                `;
                        ...
                        // destroy dulu sebelum ubah tbody
