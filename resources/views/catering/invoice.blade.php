        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body" id="card">
                    ...
                    <h5 class="card-title text-center mb-4">{{ __('Upload Invoice') }}</h5>
                    <form method="POST" action="{{ route('catering.updateInvoice', $catering->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <label for="nama_karyawan" class="col-md-4 col-form-label text-md-start">{{ __('Nama Karyawan') }}</label>
                            <div class="col-md-6">
                                <input type="hidden" name="id_karyawan" value="{{ $catering->karyawan->id }}">
                                <input disabled id="nama_karyawan" type="text" placeholder="Masukan Nama karyawan" class="form-control @error('nama_karyawan') is-invalid @enderror" name="nama_karyawan" value="{{ $catering->karyawan->nama_lengkap }}">
                                @error('nama_karyawan')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input disabled id="divisi" type="text" placeholder="Masukan Nama karyawan" class="form-control @error('divisi') is-invalid @enderror" name="divisi" value="{{ $catering->karyawan->divisi }}">
                                @error('divisi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
