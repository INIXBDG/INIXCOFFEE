                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-sm-5 col-xs-5">
                                        <p>Harga Exam (dalam dollar)</p>
                                    </div>
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <p>{{ $rkm->harga_dollar }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5 col-sm-5 col-xs-5">
                                        <p>Biaya Admin(dalam dollar)</p>
                                    </div>
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <p>{{ $rkm->biaya_admin_dollar }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5 col-sm-5 col-xs-5">
                                        <p>Harga Exam (dalam rupiah)</p>
                                    </div>
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <p>{{ $rkm->harga_rupiah }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-5 col-sm-5 col-xs-5">
