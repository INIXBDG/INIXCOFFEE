        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('target.create') }}" class="btn btn-md click-primary mx-4" data-toggle="tooltip"
                        data-placement="top" title="Tambah User"><img src="{{ asset('icon/plus.svg') }}" class=""
                            width="30px"> Buat Target</a>
                </div>
                <div class="card m-4">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#jabatantable').DataTable({
                    "ajax": {
                        "url": "{{ route('getTarget') }}", // URL API untuk mengambil data
                        "type": "GET",
                        "beforeSend": function () {
