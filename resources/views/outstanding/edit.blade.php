...
@section('content')
                        ...
                        <form method="POST" action="{{ route('outstanding.update', $outstanding->id) }}"
                                ...
                                <div class="col-md-6">
                                    <select name="id_rkm" id="id_rkm" class="form-select" disabled>
                                        <option value="{{ $outstanding->id_rkm }}">
                                            ...
                                            {{ $outstanding->rkm->perusahaan->nama_perusahaan }}</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group" role="group" aria-label="Approval Options">
                                        <input type="radio" class="btn-check" name="status_pembayaran" id="approveYes"
                                            ...
                                            {{ $outstanding->status_pembayaran == '1' ? 'checked' : '' }}>
                                        ...
                                        <input type="radio" class="btn-check" name="status_pembayaran" id="approveNo"
                                            ...
                                            {{ $outstanding->status_pembayaran == '0' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3" id="jumlah_pembayaran_row" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="jumlah_pembayaran"
                                        value="{{ $outstanding->jumlah_pembayaran }}" id="jumlah_pembayaran"
                            ...
                            <div id="potongan_section" class="row mb-3" style="display:none;">
                                            ...
                                            <div class="row mb-2 potongan-item">
                                                <div class="col-5">
                                                    <input type="text" name="jenis_potongan[]" class="form-control"
                                                        value="{{ $item['jenis'] }}" placeholder="Jenis Potongan">
                                                </div>
                                                <div class="col-5">
                                                    <input type="text" name="jumlah_potongan[]"
                                                        class="form-control jumlah-potongan"
                                                        value="{{ number_format($item['jumlah'], 0, ',', '.') }}"
                                                        placeholder="Jumlah">
                                                </div>
                                                <div class="col-2">
                                                    <button type="button"
                                                        class="btn btn-danger btn-sm remove-potongan">X</button>
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                <div class="col-md-6 offset-md-4 mt-2">
                                    <button type="button" id="add_potongan" class="btn btn-sm btn-success">
                                        + Tambah Potongan
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <select name="status_tracking" id="status_tracking" class="form-select">
                                        ...
                                        <option value="invoice"
                                            {{ $tracking_outstanding['invoice'] == '1' ? 'selected' : '' }}>Invoice
                                        </option>
                                        <option value="faktur_pajak"
                                            {{ $tracking_outstanding['faktur_pajak'] == '1' ? 'selected' : '' }}>Faktur
                                            Pajak</option>
                                        <option value="dokumen_tambahan"
                                            {{ $tracking_outstanding['dokumen_tambahan'] == '1' ? 'selected' : '' }}>
                                            Dokumen Tambahan</option>
                                        <option value="konfir_cs"
                                            {{ $tracking_outstanding['konfir_cs'] == '1' ? 'selected' : '' }}>Konfirmasi
                                            Pengiriman RPX</option>
                                        <option value="no_resi"
                                            {{ $tracking_outstanding['no_resi'] == '1' ? 'selected' : '' }}>Konfirmasi
                                            Nomor Resi</option>
                                        <option value="tracking_dokumen"
                                            {{ $tracking_outstanding['tracking_dokumen'] == '1' ? 'selected' : '' }}>Status
                                            Pengiriman Dokumen</option>
                                        <option value="konfir_pic"
                                            {{ $tracking_outstanding['konfir_pic'] == '1' ? 'selected' : '' }}>Konfirmasi
                                            PIC</option>
                                        <option value="pembayaran"
                                            {{ $tracking_outstanding['pembayaran'] == '1' ? 'selected' : '' }}>Pembayaran
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            @if (!empty($outstanding['path_faktur_pajak']))
                                <div class="row mb-3">
                                    <label
                                        class="col-md-4 col-form-label text-md-start">{{ __('File Faktur Pajak') }}</label>
                                    <div class="col-md-6">
                            ...
                            @if (!empty($outstanding['path_dokumen_tambahan']))
                                <div class="row mb-3">
                                    <label
                                        class="col-md-4 col-form-label text-md-start">{{ __('File Dokumen Tambahan') }}</label>
                                    <div class="col-md-6">
                                        <small class="text-muted">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="status_resi" id="status_resi" class="form-control"
                                        value="{{ $tracking_outstanding['status_resi'] }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="status_pic" id="status_pic" class="form-control"
                                        value="{{ $tracking_outstanding['status_pic'] }}">
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_potongan').on('click', function() {
                $('#potongan_container').append(`
                    <div class="row mb-2 potongan-item">
                        <div class="col-5">
                            <input type="text" name="jenis_potongan[]" class="form-control" placeholder="Jenis Potongan">
                        </div>
                        <div class="col-5">
                            <input type="text" name="jumlah_potongan[]" class="form-control jumlah-potongan" placeholder="Jumlah">
                        </div>
                        <div class="col-2">
                            <button type="button" class="btn btn-danger btn-sm remove-potongan">X</button>
                        </div>
                    </div>
                `);
            });
