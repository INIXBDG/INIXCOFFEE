    ...
    <table style="width:100%; margin-top:40px; border-collapse:collapse; border: 1px solid #000;">
        <tr>
            <td style="width:100%; text-align:center; vertical-align:top; border: 1px solid #000;">
                <!-- <p style="margin:0; font-weight:bold;">{{ $terbilang }}</p> -->
                <p style="margin:0;">PT. INIXINDO AMIETE MANDIRI</p>
                <p style="margin:0;">{{ $invoice->bank_name ?? 'BANK MANDIRI KK BANDUNG CIHAMPELAS' }}</p>
                <p style="margin:0;">Account No : {{ $invoice->account_number ?? '131-00-0734797-6' }}</p>
