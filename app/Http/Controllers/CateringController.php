...
class CateringController extends Controller
{
    ...
    public function create()
    {
        ...
        // $rkm = RKM::pluck('id');
        $vendor = vendor::get();
        return view('catering.create', compact('karyawan', 'vendor'));
    }
    ...
    public function show($id)
    {
        ...
        return view('catering.show', compact('data', 'dataVendor'));
    }
    ...
    public function PDF(Request $request)
    {
        ...
        $cateringData = Catering::with(['karyawan', 'DetailCatering'])
            ->where('id', $id)
            ->first();
        ...
        if ($cateringData->karyawan->divisi == 'Office') {
