...
class ApprovalPendapatanController extends Controller
{
    ...
    public function get($tahun, $bulan)
    {
        ...
        // Dapatkan awal minggu pertama yang memuat tanggal 1 bulan ini
        ...
        while ($startOfWeek->lte($endOfMonth)) {
            ...
            $rows = RKM::with(['materi', 'perusahaan', 'sales', 'instruktur', 'outstanding', 'eksam'])
            ...
            foreach ($rows as $item) {
                ...
                $weekData[] = [
                    ...
                    'exam' => $item->eksam ? 'Rp ' . number_format((float) $item->eksam->total, 0, ',', '.') : '-',
