...
class CutiExchangeNotification extends Notification implements ShouldBroadcast
{
    use Queueable, InteractsWithSockets;

    protected $data;
    protected $path;
    protected $type;        // contoh: "Cuti Tahunan", "Cuti Besar", dll
    ...
    public function toBroadcast($notifiable): BroadcastMessage
    {
        return new BroadcastMessage([
            ...
            'message' => [
                'tipe'          => $this->type, // contoh: "Cuti Tahunan", "Cuti Khusus"
                ...
                'jenis_cuti'    => $this->data['tipe'] ?? $this->type,
