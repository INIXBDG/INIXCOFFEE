...
trait KPIResolverTrait
{
    protected function resolveProgress($item, $personId)
    {
        ...
        $progress = match ($asistantRoute) {
            ...
            'biaya akuisisi perclient' => app(SalesKPIService::class)->calculateBiayaAkuisisiClient($item, $personId),
        ...
        $routesPerPeserta = ['sertifikasi kompetensi internal', 'pelatihan kompetensi eksternal'];
    ...
    protected function getCalculationByRoute($itemDetail, $personId)
    {
        ...
        return match ($route) {
            ...
            'biaya akuisisi perclient' => app(SalesKPIService::class)->calculateBiayaAkuisisiClientDetail($itemDetail, $personId),
